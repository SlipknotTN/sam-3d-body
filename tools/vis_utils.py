...
def visualize_sample_2d3d_together(img_cv2, outputs, faces):
    """
    Draw keypoints 2D and 3D meshes for all the detected people in the image

    Returns:
        img_keypoints: Image with 2D keypoints drawn on it
        img_mesh: Image with 3D meshes drawn on it
    """
    img_keypoints = img_cv2.copy()
    img_mesh = img_cv2.copy()
